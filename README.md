# B-Shell
A mostly python **Shell created** for devs(Actually we are working on bases, many tools will come in the futur
...
If you break the shell by modifie it, use Reset.py in tools and reset folder.
# WARNING
